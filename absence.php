...
$sapAbsents = new CSapAbsentsList();
$sapAbsents->loadFromJson("http://zabbix.azimut-gk.local:8080/sapProxy.php?req=YfmPersAbsents&IBegda=2000-01-01&IEndda=2099-01-01");
